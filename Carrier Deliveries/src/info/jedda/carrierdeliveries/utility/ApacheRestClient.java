 ...
 * /2011/04/13/rest-template-using-apach e-httpclient/}. The HttpClient used in this class is not
 * thread-safe.
 */
public final class ApacheRestClient implements RestClient {
	...
	private static class LazyHolder {
		private static final ApacheRestClient INSTANCE = new ApacheRestClient();
	}

	public static ApacheRestClient getInstance() {
	...
	public Header getAuthorizationHeader(String user, String password) {
		return new BasicHeader("Authorization", "Basic "
				+ Base64.encodeToString((user + ":" + password).getBytes(), Base64.NO_WRAP));
	}

	public String doGet(final String url, final Header[] headers)
	...
	public String doPatch(final String url, final HttpEntity entity, Header[] headers)
